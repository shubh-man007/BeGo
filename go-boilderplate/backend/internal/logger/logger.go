...
import (
	...
	"github.com/shubh-man007/go-boilerplate/internal/config"
)
...
func NewLoggerService(cfg *config.ObservabilityConfig) *LoggerService {
	...
	if cfg.NewRelic.LicenseKey == "" {
		fmt.Println("New Relic locense not provided skipping initialization")
		return service
	}
...
func NewLoggerWithService(cfg *config.ObservabilityConfig, loggerService *LoggerService) zerolog.Logger {
	...
	// Note: New Relic log forwarding can be configured separately if needed
